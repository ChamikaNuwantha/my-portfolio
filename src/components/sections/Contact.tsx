...
export default function Contact() {
  return (
    <section id="contact" className="py-24 max-w-2xl mx-auto text-center mb-24">
      <motion.div
      ...
      <motion.form
        ...
        className="space-y-6 text-left bg-muted/10 p-8 rounded-2xl border border-border glass"
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-primary hover:bg-primary/90 text-white font-medium py-3.5 rounded-lg flex justify-center items-center gap-2 transition-colors shadow-lg shadow-primary/20"
        >
