...
import { cn } from '../layout/Navbar'; // reuse utility
    ...
    <section id="intro" className="min-h-[90vh] flex flex-col justify-center relative pt-20">
      ...
      <div className="max-w-3xl">
        ...
        <motion.p
          ...
          className="text-lg text-muted-foreground/90 max-w-2xl leading-relaxed mb-10"
        >
          I'm an IT Graduate from the University of Moratuwa, specializing in building exceptional web applications and IoT systems. 
          When I'm not coding, you'll find me behind a camera lens capturing the world through photography. 
          Highly motivated to take initiative and deliver results effectively.
        </motion.p>
